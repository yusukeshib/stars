...
Planned schema-versioned sessions should describe reproducible inputs, not host
UI implementation details. A portable session should capture:

- observer location and elevation;
- civil input time plus any explicit DUT1 / time-scale metadata;
- view direction, field of view, projection, and viewpoint;
- overlay and label configuration;
- active corrections and atmosphere settings;
- catalog backend identity, filtering, and data snapshot / manifest reference;
- app / schema version and optional human title / description.
