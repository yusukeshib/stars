...
| `P1-09` | 1 | **Constellation lines** — modern western stick figures | `crates/renderer/data/constellation_lines.csv`, derived from BSD-licensed d3-celestial line data and converted to J2000 unit-vector line segments | ✅ done (`renderer::overlay`) |
| `P1-10` | 1 | **Constellation boundaries** — IAU/Delporte regions | `crates/renderer/data/constellation_boundaries.csv`, derived from CDS VI/49 / Delporte 1930 B1875 boundary vertices precessed to J2000 | ✅ done (`renderer::overlay`) |
