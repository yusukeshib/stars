...
| Daylight sky | Preetham / Perez daylight-domain luminance and shader approximation | Compact clear-sky model; not full spectral multiple scattering | `crates/astronomy/src/atmosphere.rs`, `crates/renderer/src/shaders/skyglow.wgsl` |
