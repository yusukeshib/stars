...
| 2 | **Sun, Moon** — apparent topocentric direction, angular radius, phase, and disk rendering inputs | VSOP87 (Sun) + ELP2000 (Moon); feeds scattering, twilight, moon phase, and rise/set. Approximate Meeus/Schlyter plumbing exists, but the roadmap item remains open until the specified models and disk-render inputs land. | ⏳ next |
| 2 | **Solar / lunar illuminants** — spectral or XYZ irradiance for direct sunlight and moonlight at the top of the atmosphere | ASTM G-173 / CIE daylight basis for Sun; Krisciunas & Schaefer 1991 for moonlight brightness. Approximate lux constants exist, but spectral/XYZ irradiance and the cited lunar brightness law are still pending. | ⏳ next |
| 2 | **Sunlit atmospheric scattering / sky colour** — Rayleigh + Mie aerosol + ozone absorption sky model driven by Sun altitude, view direction, observer altitude, and turbidity; produces blue daylight, golden-hour warmth, sunset reddening, and horizon haze | Preetham, Shirley & Smits 1999; Hosek & Wilkie 2012; Bruneton & Neyret 2008. Initial Preetham-style shader exists; ozone/Hosek-Bruneton-grade path and validation remain. | ⏳ next |
