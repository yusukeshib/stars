...
- Lieske 1977 / Lieske 1998 E5 theory — ROADMAP target for the
  `V-52b-E5` precision upgrade; the
  `crates/astronomy/src/moons/lieske_e5.rs` substitution-point
  scaffold and the `horizons-galilean-moons-fixture` manifest entry
  land in this slice;
- JPL Horizons On-Line Ephemeris System
  ...
  `scripts/fetch-horizons-galilean-moons.sh`);
...
- Vienne & Duriez 1995 A&A 297, 588 — TASS1.7 — ROADMAP target for
  the `V-52c-TASS17` precision upgrade; the
  `crates/astronomy/src/moons/tass17.rs` substitution-point scaffold
  and the `horizons-titan-fixture` manifest entry land in this slice;
- JPL Horizons On-Line Ephemeris System
  (https://ssd.jpl.nasa.gov/horizons/) — geocentric ICRF apparent
  RA / Dec / range for Saturn + Titan pinned for V-52c-TASS17 in
  `data/horizons_titan.csv` (regenerated by
  `scripts/fetch-horizons-titan.sh`);
...
- `crates/astronomy/src/moons/lieske_e5.rs` (V-52b-E5 scaffold + future
  Lieske 1998 E5 series substitution point)
- `crates/astronomy/src/moons/tass17.rs` (V-52c-TASS17 scaffold + future
  Vienne & Duriez 1995 TASS1.7 Titan series substitution point)
...
- `data/horizons_galilean_moons.csv`, generated by
  ...
  validation target for the V-52b-E5 precision upgrade — the test
  `moons::tests::meeus_grade_matches_horizons_within_meeus_budget`
  enforces the *current* (Meeus-grade) tolerance band against it so
  the precision upgrade can tighten the bound by editing one constant.
